...
function locationOnSuccess(latitude, longitude) {
  ...
  if (dist > 1) {
    ...
    $(".mhn-ui-page").hide(), $(".mhn-ui-page." + "page-home").fadeIn(500);
...
mhnUI = {
      ...
      pattern.checkForPattern(
        ...
        function(currentUser) {
          ...
          if (currentUser === "Admin") {
            $(".mhn-lock-title").html(
              '<span class="mhn-lock-success">Unlocked</span>'
            ),
              $(".patt-holder").addClass("patt-success"),
              setTimeout(function() {
        ...
        function() {
          // onError
          $(".mhn-lock-title").html(
            '<span class="mhn-lock-failure">Pattern Incorrect</span>'
          ),
  ...
  filter: function() {
    $(".mhn-ui-filter .mhn-ui-btn").click(function() {
      ...
      $(".mhn-ui-filter-list>div").click(function() {
        ...
        var e = function(t) {
          $(".mhn-ui-apps .mhn-ui-col").fadeOut(400),
            $('.mhn-ui-apps .mhn-ui-col[data-filter="' + t + '"]').fadeIn(400);
        };
        switch (t) {
          case "all":
        ...
        $(".mhn-ui-filter-list").toggle(100),
          $(".mhn-ui-filter .mhn-ui-btn").removeClass("active"),
          $(".mhn-ui-page-title").text($(this).text());
      });
  },
  colors: function() {
    $(".mhn-ui-icon span")
  ...
  dialog: {
    setup: function() {
      $(
        '.mhn-ui-dialog-wrap,.mhn-ui-dialog-wrap a[data-action="cancel"]'
      ).click(function() {
        mhnUI.dialog.hide();
      }),
    ...
    show: function(t) {
      $('.mhn-ui-dialog-wrap a[data-action="confirm"]').attr("href", t),
        $(".mhn-ui-dialog-wrap").show();
    },
    hide: function() {
      $('.mhn-ui-dialog-wrap a[data-action="confirm"]').removeAttr("href"),
        $(".mhn-ui-dialog-wrap").fadeOut(400);
    }
  }
};
...
!(function(t, e, n, a) {
  ...
  function r(t) {
    for (
      ...
      o.push(
        '<li class="patt-circ" style="margin:' +
          r +
          "px; width : " +
          2 * i +
          "px; height : " +
  ...
  function s(e, n) {
    ...
    if (0 != u.length) {
      (h.object = a),
        (n = h.option = t.extend({}, s.defaults, n)),
        r(h),
        u.addClass("patt-holder"),
        "static" == u.css("position") && u.css("position", "relative"),
        u.on("touchstart mousedown", function(t) {
          d.call(this, t, a);
        }),
    ...
    h = function(e, n) {
      ...
      if (u) {
        if (-1 == l.indexOf(c)) {
          ...
          if (o.lastPosObj) {
            for (
              ...
              var M = (w - 1) * o.option.matrix[1] + x,
                y = o.mapperFunc(M) || M;
              -1 == l.indexOf(y) &&
                (t(s[M - 1]).addClass("hovered"), l.push(y));
            }
            (v = []),
              h.j - g.j > 0 ? v.push("s") : h.j - g.j < 0 ? v.push("n") : 0,
              h.i - g.i > 0 ? v.push("e") : h.i - g.i < 0 ? v.push("w") : 0,
              (v = v.join("-"));
          }
          ...
          var E = t(
            '<div class="patt-lines" style="top:' +
              (O - 5) +
              "px; left:" +
              (C - 5) +
              'px"></div>'
    ...
    u = function(t, e) {
      ...
      n.holder.off(".pattern-move").removeClass("patt-hidden"),
        a &&
          ...
          n.line.remove(),
          n.rightPattern &&
            (a == n.rightPattern ? n.onSuccess() : (n.onError(), e.error())));
    };
  (o.prototype = {
    constructor: o,
    ...
    (s.prototype = {
      ...
      option: function(t, e) {
        ...
        return e === a
          ? i[t]
          : ((i[t] = e),
            void (("margin" == t || "matrix" == t || "radius" == t) && r(n)));
      },
      getPattern: function() {
          ...
          for (var o = 0; o < t.length; o++) {
            ...
            h.call(
              null,
              {
                ...
                pageY: f,
                preventDefault: l,
                originalEvent: { touches: [{ pageX: c, pageY: f }] }
              },
              this
            );
          }
